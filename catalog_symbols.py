...
class CatalogSymbols:
    def __init__(self): #creating a catalog CSV file
    ...
    def read_symbols(self): #if there is no file - create + reading the symbol and its frequency without the headers
